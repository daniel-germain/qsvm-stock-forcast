...
**Experiment 1**
The project applies quantum kernel methods to historical stock data to see how QSVM's compare to classic SVM's when using fewer input features (no technical indicators)
